...
Route::group(['prefix' => 'admin', 'middleware' => ['auth'], 'as' => 'admin.'], function(){
    ...
    Route::get('/broken-e', [HomeController::class, 'broken_e'])->name('broken-e');
    Route::get('/broken-m', [HomeController::class, 'broken_m'])->name('broken-m');
    Route::get('/broken-p', [HomeController::class, 'broken_p'])->name('broken-p');
