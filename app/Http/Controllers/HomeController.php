...
class HomeController extends Controller
{
    ...
    {
        $elektronikRusak = dtElektronik::where('kondisi_b', 'Rusak')->count();
        $mebeulairRusak = dtMebeulair::where('kondisi_c', 'Rusak')->count();
        $praktikRusak = dtPraktik::where('kondisi_d', 'Rusak')->count();

        return view('pages.collect-broken', compact('elektronikRusak', 'mebeulairRusak', 'praktikRusak'));
    }

    public function broken_e()
    {
        $brokenElektronik = dtElektronik::where('kondisi_b', 'Rusak')->get();
        return view('pages.broken-e', compact('brokenElektronik'));
    }

    public function broken_m()
    {
        $brokenMebeulair = dtMebeulair::where('kondisi_c', 'Rusak')->get();
        return view('pages.broken-m', compact('brokenMebeulair'));
    }

    public function broken_p()
    {
        $brokenPraktik = dtPraktik::where('kondisi_d', 'Rusak')->get();   
        return view('pages.broken-p', compact('brokenPraktik'));
    }
